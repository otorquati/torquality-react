  ...
  return ( 
    ...
    <Container>
      <section className={styles.container}>
        ...
        <div>
            <p>Há inumeras ferramentas para melhoria do desempenho de um sistema de gestão
            aqui destacamos as 7 ferramentas principais e listamos também, as mais utilizadas pelas boas práticas de gestão. 
            </p>
        </div>
